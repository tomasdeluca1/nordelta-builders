...
## 0. Setup de cuentas (hacer ANTES del Día 1)

### Handles recomendados
Usá **el mismo handle en ambas plataformas** para que sea fácil de recordar y buscar.
...
## 1. Estrategia (framework ORB aplicado)

Todo lo de redes (canal **rented**) tiene un único objetivo: empujar a la web y al grupo de WhatsApp (canales **owned**), donde sí controlás la relación.
...
- La cuenta de marca publica el contenido "oficial".
- Vos (founder) republicás / citás desde tu personal con tono en primera persona ("armé esto", "por qué lo hice"). Eso es lo que más convierte al arranque.
- Los threads marcados como *(founder)* abajo están escritos en primera persona para tu cuenta personal.
...
| Pilar | % | Qué es |
|---|---|---|
| 🏗️ Comunidad / quiénes somos | 30% | Manifiesto, spotlights de miembros, "por qué existimos" |
| 🔨 Build in public | 20% | Cómo armamos la comunidad, números, detrás de escena (estética terminal) |
| 🧠 Valor / conocimiento | 25% | Tips, recursos, recortes del ecosistema tech de zona norte |
| 📅 Eventos / acción | 15% | Kick-off, workshops, hackathon, convocatorias |
| 🚀 CTA / sumate | 10% | Posts directos al signup |

---

## 3. Calendario de arranque (Días relativos)

Cadencia objetivo: **X 1–2 posts/día**, **IG 4–5 posts + Stories** en las 2 primeras semanas. Mejores horarios AR: 8–9h, 13h, 19–21h.

| Día | X (Twitter) | Instagram |
|---|---|---|
...
| **7** | Retweet/cita de algún miembro + engagement | Stories: behind the scenes |
| **8** | `X6` Pregunta/engagement | `IG5` Reel build-in-public |
| **9** | `X4`-variante o recorte de valor | `IG4` Spotlight de miembro #2 |
| **10** | `X8` Social proof / recap | Carrusel: "qué se viene" (eventos) |
| **11–14** | Ritmo: 1 valor + 1 comunidad por día | Spotlights + 1 Reel + Stories diarias |

Después del Día 14 → ritmo sostenido (sección 8).
...
No es otro grupo de WhatsApp donde se tiran links y nadie hace nada.

Es una comunidad para construir cosas reales —startups, proyectos, side-projects— con gente de zona norte que también está buildeando.
—
¿Qué vas a encontrar adentro?

→ Founders buscando co-founders y early hires
→ Devs y makers shippeando productos
→ Workshops técnicos y talks de founders
→ Inversores y mentores de la zona

Presencial + online.
—
Arrancamos con un kick-off (fecha que confirmamos pronto) y seguimos con workshops y un hackathon.
...
RT para que llegue a quien tiene que llegar 🚀
```
...
Charlar está bien. Shippear está mejor.
...
```
Hot take: el 90% de las "comunidades tech" son grupos de WhatsApp muertos.
...
Conectamos founders con co-founders, early hires y primeros usuarios.

Tu próximo socio puede estar viviendo a 5 minutos.
—
2. Conocimiento 🧠

Workshops técnicos, talks de founders y sesiones de Q&A.

Aprendés de gente que ya lo hizo. No de un curso random de YouTube.
—
3. Red de contactos 🤝

Inversores, mentores y corporaciones de zona norte.

Las puertas que sola/o tardás años en abrir, acá se abren en un asado.
—
4. Acción real ⚡
...
```
Vivo en zona norte y siempre me pasó lo mismo:

había talento tech increíble alrededor, pero nadie se conocía. Cada uno buildeando solo en su depto.
...
—
No quiero que sea otro Discord o WhatsApp que muere en 2 semanas.

Quiero que de acá salgan startups, contrataciones, sociedades. Las cosas que pasan cuando juntás a la gente correcta en el mismo lugar.
—
...
### X6 · Pregunta / engagement
```
Pregunta para los que están en tech en zona norte:

¿Qué te falta más hoy?
...
→ 40+ founders, devs y makers adentro
→ Kick-off en camino
→ Una comunidad tech real en zona norte, no un grupo más
...
- **Slide 5:** "⚡ Acción real — no hablamos, construimos"
- **Slide 6 (CTA):** "Sumate gratis → link en bio"
...
🤝 Una red de inversores y mentores de la zona
⚡ Acción: construimos cosas juntos

Todo presencial + online, acá en zona norte.
...
- **Slide 5 (CTA):** "Conocé a builders como [Nombre] → link en bio"
...
1. "Ya estamos en Instagram 🌊" + sticker de seguir
2. Repost del carrusel IG1 con "Mirá esto 👆"
...
|---|---|---|
| `ig1-lanzamiento-01..06.png` | Carrusel de lanzamiento (IG1) — 6 slides | 2160×2700 (4:5) |
| `ig2-pilares-01..06.png` | Carrusel 4 pilares (IG2) — 6 slides | 2160×2700 (4:5) |
| `x-header.png` | Header de perfil de X | 3000×1000 (3:1) |
| `story-sumate.png` | Story "Sumate" | 2160×3840 (9:16) |

**Para regenerar o editar** (cambiar copy, agregar slides, crear el spotlight): editá `marketing/assets-generator/build.mjs` y corré:
```bash
node marketing/assets-generator/build.mjs
```
El script embebe las fuentes de `/public/assets/fonts/` y el logo, y screenshotea con Chrome headless. Cada slide es un objeto en los arrays `ig1` / `ig2` → duplicás uno para sumar piezas (spotlight de miembro, anuncio de evento, etc.).

> **Avatar de perfil:** usá `/public/assets/logo.png` directo (ya es el logo con glow sobre fondo oscuro). Para el Reel, usá las piezas como frames de portada/cierre.

---

## 7. Dirección visual de los assets

Para que todo se vea como la web y el `og.png`:
- **Fondo:** `#05070A` (o `#0A0E12`). Nada de blanco.
- **Texto:** `#E6EDF3` principal, `#8194A3` secundario.
- **Acento/CTA/glow:** `#00E5A0` (verde neón). Glow: `drop-shadow(0 0 8px rgba(0,229,160,.35))`.
- **Fuentes:** títulos **Bebas Neue** (mayúsculas), labels/tags/código **Space Mono**, párrafos **DM Sans**. Los .ttf están en `/public/assets/fonts/`.
- **Recursos:** grilla animada de fondo, "orbes" de colores tenues, leve grano de film. Estética terminal (`$ comando`) para posts dev.
- **Logo:** `/public/assets/logo.png`.
- **Templates:** armá 1 plantilla de carrusel + 1 de Reel + 1 de Story en Canva/Figma reutilizando estos tokens para producir rápido cada semana.

---

## 8. Ritmo sostenido (después del Día 14)

No es un evento de un día. Mantené momentum:
- **X:** 1–2 posts/día → 1 de valor (tip/recorte del ecosistema) + 1 de comunidad (spotlight, win de un miembro, build-in-public). 1 thread/semana.
- **IG:** 3–4 posts/semana + Stories casi diarias. 1 Reel/semana (el formato de mayor alcance).
- **Reciclá:** cada thread de X → carrusel de IG. Cada evento → fotos/Reels (story arc) durante 1–2 semanas.
- **Eventos:** cuando confirmes el kick-off, hacé una mini-secuencia: anuncio → countdown en Stories → "quedan X lugares" → recap con fotos/Reel después (esto alimenta meses de contenido).
- **Engagement diario (30 min):** responder todos los comentarios, comentar en 5–10 cuentas tech de zona norte, mandar 2–3 DMs a nuevos seguidores invitándolos al grupo.
...
**Día 1**
- [ ] Publicar y **fijar** el thread `X1`
- [ ] Publicar carrusel `IG1` + secuencia de Stories
- [ ] Founder (cuenta personal) cita/republica el lanzamiento
- [ ] Avisar al grupo de WhatsApp: "ya estamos en IG y X, seguinos y compartan"
- [ ] Pedir a los 40 founding members que sigan y compartan (borrowed reach)

**Semana 1–2**
- [ ] Seguir el calendario (sección 3)
- [ ] Engagement diario (30 min)
- [ ] Identificar 20–50 cuentas tech de zona norte para interactuar

**Post**
- [ ] Recap de social proof (`X8`)
- [ ] Pasar a ritmo sostenido (sección 8)
- [ ] Cuando haya fecha de kick-off → mini-secuencia de evento
```
